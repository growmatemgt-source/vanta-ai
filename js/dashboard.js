...
(() => {
  ...
  const boot = async () => {
    ...
    const loadProfile = async () => {
      ...
      /*
         Plan is currently UI-only.
         It is NOT read from the profiles table.
      */
      if ($("planValue")) {
    ...
    const switchView = (viewName) => {
      ...
      const selectedView = $("view-" + viewName);
      ...
      if (!data || data.length === 0) {
        grid.innerHTML = `
          <div class="project-card">
            ...
            <p>
              Your VANTA AI projects will appear
